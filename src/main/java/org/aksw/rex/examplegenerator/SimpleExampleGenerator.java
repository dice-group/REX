...
public class SimpleExampleGenerator implements ExampleGenerator {
    ...
    /*
     * (non-Javadoc) @see
     * org.aksw.rex.examplegenerator.ExampleGenerator#setEndpoint(org.dllearner.kb.sparql.SparqlEndpoint)
     */
    @Override
...
//		qef = new QueryExecutionFactoryPaginated(qef, 10000);
    ...
    /*
     * (non-Javadoc) @see
     * org.aksw.rex.examplegenerator.ExampleGenerator#setPredicate(com.hp.hpl.jena.rdf.model.Property)
     */
    @Override
...
//		examples.addAll(getNegativeExamplesRandomSubjectInDomainRandomObjectInRange(10));
    ...
    /*
     * (non-Javadoc) @see
     * org.aksw.rex.examplegenerator.ExampleGenerator#setMaxNrOfPositiveExamples(int)
     */
    @Override
    ...
    /*
     * (non-Javadoc) @see
     * org.aksw.rex.examplegenerator.ExampleGenerator#setMaxNrOfNegativeExamples(int)
     */
    @Override
